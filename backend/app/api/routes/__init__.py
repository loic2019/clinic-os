...
`/api/appointments`. Phase 5 adds `/api/laboratory`. Later phases will
add: /api/imaging, /api/pharmacy, /api/hospitalization, /api/emergency,
/api/invoices, /api/payments, /api/cash, /api/accounting,
/api/inventory, /api/suppliers, /api/hr, /api/payroll, /api/reports,
/api/notifications, /api/audit, /api/dashboard, /api/search, /api/ai
"""
